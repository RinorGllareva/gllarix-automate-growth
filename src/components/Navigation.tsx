          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="text-xl font-light text-white tracking-wider">
                <img src="/Gllarix_Icon PNG.png" alt="Gllarix AI Voice Agents and Business Automation Platform" className="h-10 sm:h-12 md:h-[60px] w-auto" loading="eager" fetchPriority="high" />
              </div>
            </div>
