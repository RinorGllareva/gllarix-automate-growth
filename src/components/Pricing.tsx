        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card-feature">
              <h4 className="text-xl font-bold text-foreground mb-4">Usage-Based Billing</h4>
            ...
            <div className="card-feature">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">Free setup and onboarding</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="h-5 w-5 text-success" />
                  <span className="text-sm text-muted-foreground">AI agent training for your business</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="h-5 w-5 text-success" />
                  <span className="text-sm text-muted-foreground">Integration support</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="h-5 w-5 text-success" />
                  <span className="text-sm text-muted-foreground">Regular performance optimization</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <h3 className="text-2xl font-bold text-foreground mb-4">Questions about pricing?</h3>
            <p className="text-muted-foreground mb-6">
              Our team can help you choose the right plan and estimate costs based on your specific needs.
            </p>
