...
const Pricing = () => {
  ...
  const { ref: factorsRef, isVisible: factorsVisible } =
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed px-4">
              No fixed packages. Your pricing adapts to your business complexity
              and growth.
            </p>
          </div>
                ...
                <div className="relative bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-xl border-2 border-primary/30 rounded-2xl sm:rounded-3xl md:rounded-[3rem] p-6 sm:p-8 md:p-12 lg:p-16">
                  ...
                  <div className="relative text-center">
                    ...
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8 px-4">
                      Every business is unique. Your pricing is{" "}
                      <span className="text-primary font-bold">
                        custom-built
                      </span>{" "}
                      based on your specific needs, complexity, and goals.
                    </p>
          ...
          >
            <div className="text-center mb-12 sm:mb-16 px-4">
              ...
              <p className="text-base sm:text-lg text-gray-400">
                We tailor pricing based on these key factors
              </p>
            </div>
              ...
              {pricingFactors.map((factor, index) => {
                ...
                return (
                  ...
                  >
                    {/* Gradient Background */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${factor.gradient} opacity-0 group-hover:opacity-10 rounded-xl sm:rounded-2xl transition-opacity duration-300`}
                    />

                    <div className="relative">
                      <div
                        className={`inline-flex p-3 sm:p-4 rounded-lg sm:rounded-xl bg-gradient-to-br ${factor.gradient} mb-4 sm:mb-6`}
                      >
          ...
          <div className="mt-16 sm:mt-20 flex justify-center px-4">
            <div className="bg-gradient-to-r from-primary/20 to-purple-500/20 border border-primary/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 max-w-3xl w-full">
              ...
              <p className="text-gray-400 mb-6 text-sm sm:text-base md:text-lg text-center">
                ...
                quote tailored to your business.
              </p>
              <div className="flex justify-center">
                <Button
                  asChild
                  className="bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg rounded-xl font-semibold transition-all hover:scale-105 w-full sm:w-auto"
                >
